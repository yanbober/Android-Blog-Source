...
//        mFloatingActionButton = (FloatingActionButton) this.findViewById(R.id.action_button);
//        mFloatingActionButton.setRippleColor(Color.GRAY);
//        mFloatingActionButton.setBackgroundDrawable(getResources().getDrawable(android.R.drawable.ic_menu_add));
//
